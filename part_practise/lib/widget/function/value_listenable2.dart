...
///另外一种监听变化的方案
class ValueListenable2RoutePage extends SimplePageRoute {
  ValueListenable2RoutePage({super.key}) : super("ValueListenable 监听变化-同级");
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Column(
        children: [
          Text("$clickTimes"),
          // ValueListenableBuilder跟底部的Button一个级别
